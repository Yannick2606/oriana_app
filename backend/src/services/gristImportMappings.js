...
export const importConfig = {
  ...
  Lots: { target: 'lots', values: (f) => ({ nom: field(f, 'nom', 'nom_lot'), numero: field(f, 'numero'), surface: field(f, 'surface'), divisible: booleanValue(field(f, 'divisible')), nombre_parking: field(f, 'nombre_parking'), en_bloc: booleanValue(field(f, 'en_bloc')) }), required: ['nom'], refs: { site_id: ['Sites', ['site_id', 'site']], batiment_id: ['Batiments', ['batiment_id', 'batiment']], gestionnaire_id: ['Utilisateurs', ['gestionnaire', 'consultant_responsable_id']], agence_id: ['Agences', ['agence_id']] }, lists: { cellules: (f) => listValue(field(f, 'cellules')) } },
