const tableDefinitions = {
  ...
  Lots: { table: 'lots', fields: { nom: 'nom', numero: 'numero', site_id: 'site_id', batiment_id: 'batiment_id', surface: 'surface', divisible: 'divisible', nombre_parking: 'nombre_parking', en_bloc: 'en_bloc', gestionnaire: 'gestionnaire_id', agence_id: 'agence_id' }, lists: { cellules: { table: 'lot_cellules', owner: 'lot_id', value: 'cellule_id' } } },
