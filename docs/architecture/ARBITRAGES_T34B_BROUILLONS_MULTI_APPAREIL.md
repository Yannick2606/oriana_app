...
> **Support de décision non normatif — 20 juillet 2026.** Les dix réponses ont été acceptées et
> inscrites sous DEC-023 à DEC-032 dans le registre des décisions, qui seul fait autorité.
...
Les dix réponses sont validées. Le premier lot peut implémenter uniquement les politiques pures, le code de
conflit et l’extension du contrat de port. Cette étape ne nécessite ni PostgreSQL, ni stockage objet,
ni navigateur et reste réversible. La persistance et les routes viennent dans un lot distinct après
revue de ce noyau.
