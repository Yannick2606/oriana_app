...
> **Statut : contrat validé, premier lot pur implémenté — 20 juillet 2026.** Ce document fixe T-34B
> par DEC-023 à DEC-032. Le premier lot ne crée aucune table, route, interface, donnée locale
> persistante ni capacité de production.
...
Une modification ne peut changer ni l’auteur, ni l’agence, ni l’état, ni la version, ni les dates
serveur, ni les fichiers, ni la géolocalisation, ni les références techniques. Une propriété absente
du catalogue de modification est refusée ; elle n’est pas ignorée silencieusement.
...
des seuls champs modifiables. Un objet absent ou non visible ne restitue aucune version ni valeur.
...
Les entrées sont des données externes non fiables. Le commentaire est limité à 2 000 caractères ; les types et cibles
sont contrôlés par les catalogues T-34A ; les champs inconnus, versions absentes, nulles ou non
entières et modifications d’une Capture soumise sont refusés.
