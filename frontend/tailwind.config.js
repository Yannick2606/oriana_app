    ...
    extend: {
      colors: {
        oriana: {
          ...
          navigationSurface: 'rgb(var(--color-navigation-surface) / <alpha-value>)',
          navigationText: 'rgb(var(--color-navigation-text) / <alpha-value>)',
          navigationMuted: 'rgb(var(--color-navigation-muted) / <alpha-value>)',
          navigationBorder: 'rgb(var(--color-navigation-border) / <alpha-value>)',
          aubergine: '#3D1E4D',
          violet: '#9C27B0',
          lavande: '#B39DDB',
          lavandeMoyen: '#CE93D8',
